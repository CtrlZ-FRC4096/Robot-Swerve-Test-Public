...
class XboxCommandController():
	...
	def __init__(self, port: int) -> None:
		...
		self.LEFT_BUMPER = Button(lambda: xbox.getBumper(left))
		self.RIGHT_BUMPER = Button(lambda: xbox.getBumper(right))
		self.START = Button(xbox.getStartButton)
		self.BACK = Button(xbox.getBackButton)
		self.LEFT_STICK = Button(lambda: xbox.getStickButton(left))
		self.RIGHT_STICK = Button(lambda: xbox.getStickButton(right))
	...
	def setLeftRumble(self, intensity = 1):
		...
		"""
		self.xboxController.setRumble(GenericHID.RumbleType.kLeftRumble, intensity)
	...
	def setRightRumble(self, intensity = 1):
		...
		:param intensity: How powerful the vibration should be
		"""
		self.xboxController.setRumble(GenericHID.RumbleType.kRightRumble, intensity)
